...
class OwnerProfile extends Component{
            ...
            .then(response => {
                ...
                if(response.status === 200){
                    ...
                    this.setState({
                        ...
                        //description : response.data.responseMessage.description,
                        //timings : response.data.responseMessage.timings
                    })
    ...
    onSubmit(e){
        e.preventDefault();
            ...
            // profileData.append("timings", data.timings);
        ...
        return (
            <div>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="col-sm-10">
                        <input type="text" onChange = {this.changeHandler} value={this.state.description} class="form-control" id="description" placeholder="Description" name="Describe"/>
                    </div>
                    </div>
                    <div class="form-group">
